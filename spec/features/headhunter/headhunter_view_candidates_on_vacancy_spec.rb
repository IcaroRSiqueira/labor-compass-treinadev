...
feature 'Headhunter view candidates on vacancy' do
  scenario 'from home page' do
    ...
    create(:profile, candidate: candidate, social_name: 'Leticia Silva',
                      education: 'Graduação em ADS pela USP')
    create(:entry, candidate: candidate, vacancy: vacancy)
    candidate2 = create(:candidate, email: 'test2@test.com', status: :complete)
    create(:profile, candidate: candidate2, social_name: 'Jose Antonio',
                      education: 'Eletronica pela ETEC')
    create(:entry, candidate: candidate2, vacancy: vacancy)
    candidate3 = create(:candidate, email: 'test3@test.com', status: :complete)
    create(:profile, candidate: candidate3, social_name: 'Maria Leite',
                      education: 'Ciencias da computaçao pela FMU')
