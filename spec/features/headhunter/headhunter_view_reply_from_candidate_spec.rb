...
feature 'Candidate accept proposal' do
  scenario 'from home page' do
    ...
    proposal = create(:proposal, entry: entry, candidate: candidate,
                                  headhunter: headhunter, status: :refused)
    proposal2 = create(:proposal, entry: entry2, candidate: candidate2,
                                  headhunter: headhunter, status: :accepted)
    create(:report, proposal: proposal, body: "Infelizmente a minha expecativa \
de salario esta acima da oferecida")
    create(:report, proposal: proposal2, body: 'Telefone: (00) 0-0000-0000)')
    ...
    expect(page).to have_content("Infelizmente a minha expecativa de salario \
esta acima da oferecida")
