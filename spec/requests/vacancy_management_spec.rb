...
describe 'Vacancy Management' do
  context 'show' do
    it 'renders vacancy correctly' do
      ...
      vacancy = Vacancy.create!(title: 'Desenvolvedor Web',
                                description: 'Desenvilvimento de
                                  paginas web com ruby on rails',
  ...
  context 'index' do
    it 'render vacancies index' do
      headhunter = Headhunter.create!(email: 'test@test.com',
                                      ...
                                      name: 'Teste Enterprises')
      vacancy = [
        Vacancy.create!(title: 'Desenvolvedor Web',
                        description: 'Desenvilvimento de paginas
                          web com ruby on rails',
                        skill: 'Experiencia com ruby on rails',
                        wage: '3000', role: 'Junior',
                        end_date: 15.day.from_now, location: 'Av Paulista',
                        headhunter: headhunter, status: :avaiable),
        Vacancy.create!(title: 'Desenvolvedor Web2',
                        description: 'Desenvilvimento de paginas
                          web com ruby on rails2',
                        skill: 'Experiencia com ruby on rails2', wage: '30002',
                        role: 'Junior2',
                        end_date: 15.day.from_now, location: 'Av Paulista',
                        headhunter: headhunter, status: :avaiable)
      ]
